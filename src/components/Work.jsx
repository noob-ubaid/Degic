...
const Work = () => {
  return (
    <section>
        <div className='flex items-center mt-10 lg:mx-0 mx-4 flex-col lg:flex-row gap-10'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col lg:items-start lg:ml-8 items-center'>
